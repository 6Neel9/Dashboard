...
const HeatmapOnMap = ({addressPointsData}:any) => {
  const initialMapCenter:LatLngTuple = [40.7128, -74.0060];
  const [mapCenter, setMapCenter] =  useState<LatLngTuple>(initialMapCenter);
